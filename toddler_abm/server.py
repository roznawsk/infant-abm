...
def toddler_abm_portrayal(agent):
    ...
    if type(agent) is Toddler:
        portrayal["Shape"] = "wolf_sheep/resources/toddler.png"
...
canvas_element = mesa.visualization.CanvasGrid(toddler_abm_portrayal, 10, 10, 900, 900)
...
model_params = {
    ...
    "initial_bricks": mesa.visualization.Slider(
        "Initial Brick Population", 15, 1, 50
    ),
